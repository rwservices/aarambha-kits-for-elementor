 ...
 * @since 1.0.0
 */
class Aarambha_Kits_Block_Element_11 extends Base_Widget {
	...
	public function get_name() {
		return 'aarambha-kits-block-posts-5-container';
	}
	...
	public function get_title() {
		return esc_html__( 'Block Posts 5', 'aarambha-kits' );
	}
	...
	public function get_icon() {
		return 'aarambha-kits-badge block-element-11';
	}
	...
	protected function __init_style_content_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'separator'  => 'after',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'exclude'     => array( 'image' ),
				'selector'    => '{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap',
				'label_block' => false,
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'   => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .blog-post-large .aarambha-kits-post-detail-wrap .entry-categories' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'   => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .blog-post-large .aarambha-kits-post-detail-wrap .entry-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'   => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .blog-post-large .aarambha-kits-post-detail-wrap .aarambha-kits-entry-meta' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'   => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .blog-post-large .aarambha-kits-post-detail-wrap .entry-excerpt' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				),
			)
		);
	...
	protected function __init_style_image_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'   => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .column-2 .blog-post-list .aarambha-kits-posts-wrapper .post-thumbnail-wrap' => 'width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .blog-post-list .aarambha-kits-posts-wrapper .post-thumbnail-wrap' => 'width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .column-2 .blog-post-list .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap' => 'width: calc(100% - {{SIZE}}{{UNIT}});',
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .blog-post-list .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap' => 'width: calc(100% - {{SIZE}}{{UNIT}});',
				),
			)
		);
	...
	protected function __init_style_categories_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap .entry-categories >*' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'separator'  => 'after',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap .entry-categories >*',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .blog-post-large .aarambha-kits-post-detail-wrap .entry-categories >*' => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .blog-post-list .aarambha-kits-post-detail-wrap .entry-categories >*' => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap .entry-categories >*' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap .entry-categories >*:hover' => 'color: {{VALUE}}',
				),
			)
		);
	...
	protected function __init_style_title_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'exclude'  => array( 'font_size' ),
				'selector' => '{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap .entry-title',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .blog-post-large .aarambha-kits-post-detail-wrap .entry-title a' => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .blog-post-list .aarambha-kits-post-detail-wrap .entry-title a' => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap .entry-title a' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap .entry-title a:hover' => 'color: {{VALUE}}',
				),
			)
		);
	...
	protected function __init_style_excerpt_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap .entry-excerpt',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap .entry-excerpt p' => 'color: {{VALUE}}',
				),
			)
		);
	...
	protected function __init_style_meta_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'exclude'  => array( 'font_size' ),
				'selector' => '{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap .aarambha-kits-entry-meta >*',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .blog-post-large .aarambha-kits-post-detail-wrap .aarambha-kits-entry-meta >*' => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .blog-post-large .aarambha-kits-post-detail-wrap .aarambha-kits-entry-meta .byline img' => 'height: {{SIZE}}{{UNIT}};width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap .aarambha-kits-entry-meta *' => 'color: {{VALUE}}',
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-entry-meta > div::before' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap .aarambha-kits-entry-meta a:hover' => 'color: {{VALUE}}',
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap .aarambha-kits-entry-meta a:hover span' => 'color: {{VALUE}}',
					'{{WRAPPER}} .aarambha-kits-block-posts-5-container .aarambha-kits-posts-wrapper .aarambha-kits-post-detail-wrap .aarambha-kits-entry-meta a:hover time' => 'color: {{VALUE}}',
				),
			)
		);
	...
	protected function render() {
		...
		// Posts Layout 5 container
		$this->add_render_attribute( 'posts_layout_5_container', 'class', 'aarambha-kits-container aarambha-kits-block-posts-5-container' );

		// Posts Columns Wrapper
		$this->add_render_attribute( 'Posts_Layout_5_columns_wrapper', 'class', 'columns aarambha-kits-design-grid' );
		$this->add_render_attribute( 'Posts_Layout_5_columns_wrapper', 'data-columns', 1 );
		$this->add_render_attribute( 'Posts_Layout_5_columns_wrapper', 'data-columns-md', 2 );
