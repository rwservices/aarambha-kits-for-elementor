...
export const RenderWidget = ( props ) => {
	...
	return (
		<Fragment>
			...
			<div className="columns" data-columns="1" data-columns-md="2" data-columns-lg="3">
				...
				<CardBody className="column">
					...
					<CardMedia>
						<img src={`${URL}/assets/build/images/block-widget-1.png`}/>
					</CardMedia>
				</CardBody>
				...
				<CardBody className="column">
					...
					<CardMedia>
						<img src={`${URL}/assets/build/images/block-widget-2.png`}/>
					</CardMedia>
				</CardBody>
				...
				<CardBody className="column">
					...
					<CardMedia>
						<img src={`${URL}/assets/build/images/block-widget-3.png`}/>
					</CardMedia>
				</CardBody>
				...
				<CardBody className="column">
					...
					<CardMedia>
						<img src={`${URL}/assets/build/images/block-widget-4.png`}/>
					</CardMedia>
				</CardBody>
				...
				<CardBody className="column">
					...
					<CardMedia>
						<img src={`${URL}/assets/build/images/block-widget-5.png`}/>
					</CardMedia>
				</CardBody>
				...
				<CardBody className={`column ${ proLabel }`}>
					...
					<CardMedia>
						<img src={`${URL}/assets/build/images/block-widget-6.png`}/>
					</CardMedia>
				</CardBody>
				...
				<CardBody className={`column ${ proLabel }`}>
					...
					<CardMedia>
						<img src={`${URL}/assets/build/images/block-widget-7.png`}/>
					</CardMedia>
				</CardBody>
				...
				<CardBody className={`column ${ proLabel }`}>
					...
					<CardMedia>
						<img src={`${URL}/assets/build/images/block-widget-8.png`}/>
					</CardMedia>
				</CardBody>
				...
				<CardBody className={`column ${ proLabel }`}>
					...
					<CardMedia>
						<img src={`${URL}/assets/build/images/block-widget-9.png`}/>
					</CardMedia>
				</CardBody>
