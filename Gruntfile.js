  ...
  grunt.initConfig({
    ...
    makepot: {
      target: {
        options: {
          domainPath: "/",
          mainFile: "aarambha-kits-for-elementor.php",
          potFilename: "languages/aarambha-kits-for-elementor.pot",
          potHeaders: {
            poedit: true,
    ...
    addtextdomain: {
      options: {
        textdomain: "aarambha-kits-for-elementor",
      },
      target: {
        files: {
          src: [
    ...
    checktextdomain: {
      standard: {
        options: {
          text_domain: "aarambha-kits-for-elementor", //Specify allowed domain(s)
          keywords: [
